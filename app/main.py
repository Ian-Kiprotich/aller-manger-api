...
#Create an endpoint that will be able to reset all previous reservations made in the last 
#24HRS inactive 

#HINT: all tables have an 'active' field in the document, make the active false for all 
#reservations made using pymongo 
